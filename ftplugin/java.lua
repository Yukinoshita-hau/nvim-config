...
buf_map('n', '<leader>sr', ':!mvn spring-boot:run<CR>', 'Spring Boot: запуск')

buf_map('n', '<leader>cf', vim.lsp.buf.format, 'Spring: форматирование')

buf_map('n', '<leader>ca', vim.lsp.buf.code_action, 'Spring: code action')
